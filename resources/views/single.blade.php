            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{ asset($post->user->profile->avatar) }}" alt="{{ $post->user->name }}" width="100px" height="100px" style="border-radius: 50%;">
                    </div>
                    ...
                    <div class="blog-details-author-content">
                        ...
                        <div class="socials">
                            ...
                            <a href="https://www.{{ $post->user->profile->facebook }}" class="social__item" target="_blank">
                                <img src="{{ asset('app/svg/circle-facebook.svg') }}" alt="facebook">
                            </a>
                            <a href="https://www.{{ $post->user->profile->youtube }}" class="social__item" target="_blank">
